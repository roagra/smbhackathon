    ...
    public static PostCodeResponse getPostCode(String toAddress) {
        ...
        try {
            Request request = new Request.Builder().
                    url("http://api.pitneybowes.com/location-intelligence/geocode-service/v1/transient/premium/geocode?country=USA&mainAddress="+ toAddress +"&matchMode=Standard&fallbackGeo=true&fallbackPostal=true&maxCands=1&streetOffset=7&streetOffsetUnits=METERS&cornerOffset=7&cornerOffsetUnits=METERS").
                    addHeader("Authorization", "Bearer " + checkToken(PROD_TOKEN)).
